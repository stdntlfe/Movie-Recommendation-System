  ...
  fluidRow(
    column(12,
           helpText("For a detailed description of this project please visit", 
                    a("the link", href="https://github.com/stdntlfe/Movie-Recommendation-System", target="_blank")),
           helpText("For a code, press", a("here", href = "https://github.com/stdntlfe/Movie-Recommendation-System", target="_blank"))
